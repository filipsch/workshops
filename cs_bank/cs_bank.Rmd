...
```{r import}
# Change to path of cs_bank/
setwd("~/workspace/r-workshop/cs_bank/")
...
Highly skewed distribution (way less subscribers than non-subscribers): accuracy is not a good metric. ROC is better!
